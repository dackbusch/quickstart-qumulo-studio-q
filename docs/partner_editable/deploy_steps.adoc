...
. Sign in to your AWS account.
. Open https://aws.amazon.com/marketplace/server/procurement?productId=edeb9751-4819-40ad-a593-04b6572694e7[the page for the Qumulo AMI in AWS Marketplace], and then choose *Continue to Subscribe*.
